...
class NcnnProfiler(BaseProfiler):
    use_gpu = None

    def __init__(self, dst_kernel_path, default_benchamrk_path, graph_path='', dst_graph_path='', serial='', num_threads=1, num_runs=50, warm_ups=10):
        """
        @params:
